...
func (x *RatingRequest) GetMovieId() string {
	if x != nil {
		return x.MovieId
	}
	return ""
...
type RatingResponse struct {
	...
	Dislike int64  `protobuf:"varint,3,opt,name=dislike,proto3" json:"dislike,omitempty"`
}
...
func (x *RatingResponse) GetMovieId() string {
	if x != nil {
		return x.MovieId
	}
	return ""
...
func (x *RatingResponse) GetLike() int64 {
	if x != nil {
		return x.Like
	}
	return 0
...
func (x *RatingResponse) GetDislike() int64 {
	if x != nil {
		return x.Dislike
	}
	return 0
...
var file_rating_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x72, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x29,
	...
	0x52, 0x07, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x49, 0x64, 0x22, 0x58, 0x0a, 0x0e, 0x52, 0x61, 0x74,
	...
	0x76, 0x69, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69, 0x6b, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x04, 0x6c, 0x69, 0x6b, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x69, 0x73,
	0x6c, 0x69, 0x6b, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x64, 0x69, 0x73, 0x6c,
	0x69, 0x6b, 0x65, 0x32, 0x3f, 0x0a, 0x0d, 0x52, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x2e, 0x0a, 0x09, 0x67, 0x65, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6e,
	0x67, 0x12, 0x0e, 0x2e, 0x52, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_rating_proto_goTypes = []interface{}{
	...
	(*RatingResponse)(nil), // 1: RatingResponse
}
var file_rating_proto_depIdxs = []int32{
	0, // 0: RatingService.getRating:input_type -> RatingRequest
	1, // 1: RatingService.getRating:output_type -> RatingResponse
